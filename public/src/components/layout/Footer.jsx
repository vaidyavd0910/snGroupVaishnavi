      ...
      <div className="mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <Link to="/" className="inline-block mb-6">
              <span className="text-2xl font-bold">DonateHope</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              We're on a mission to create positive change through the power of generosity. Your donations help transform lives and communities around the world.
            </p>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} DonateHope. All rights reserved.
          </p>
