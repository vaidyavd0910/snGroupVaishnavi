...
import { FaCalendarAlt, FaMapMarkerAlt, FaClock, FaFilter, FaSearch, FaArrowRight, FaGlobe, FaUsers } from "react-icons/fa";
            ...
            <SwiperSlide key={event._id}>
              <div className="bg-white rounded-2xl shadow-soft overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-2 h-[520px] flex flex-col group">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <h4
                    className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:line-clamp-none group-hover:whitespace-normal"
                    title={event.title}
                  >
                    {event.title}
                  </h4>
                  <p
                    className="text-gray-600 text-sm mb-4 line-clamp-2 group-hover:line-clamp-none group-hover:whitespace-normal flex-1"
                  ...
                  <div className="flex space-x-3">
                    <button
                      className="flex-1 text-white py-3 px-4 rounded-xl font-semibold hover:bg-primary-600 flex items-center justify-center space-x-2"
