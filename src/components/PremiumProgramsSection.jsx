...
const PremiumProgramsSection = () => {
  ...
  const generatePremiumPrograms = () => {
    return [
      ...
      },
      {
        ...
        description: 'Fast-track program for aspiring entrepreneurs to build and scale their startups.',
        duration: '16 weeks',
        status: 'upcoming',
        difficulty: 'advanced',
        category: 'Business',
  ...
  const applyFilters = () => {
    let filtered = [...programs]; // ✅ avoid mutating state
                ...
                <div className="bg-white rounded-2xl shadow-soft overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-2 h-[520px] flex flex-col group">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-2xl font-bold text-primary-500">{program?.price}</span>
