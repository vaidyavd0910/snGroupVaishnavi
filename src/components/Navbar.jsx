...
const Button = ({ children, variant = "primary", onClick, className = "", ...props }) => {
  ...
  const variants = {
    primary: "bg-gradient-to-r from-primary-500 to-primary-500 text-white hover:from-primary-700 hover:to-secondary-700 focus:ring-primary-500 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5",
